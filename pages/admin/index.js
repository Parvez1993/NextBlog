          ...
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">Incomplete Blogs</p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">Processing Blogs</p>
              </div>
            </div>
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-200 p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">Completed</p>
              </div>
            </div>
          </div>
        </div>
